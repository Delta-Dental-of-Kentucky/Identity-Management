...
using Identity.Management.STS.Identity.Configuration;
using Identity.Management.STS.Identity.Configuration.ApplicationParts;
using Identity.Management.STS.Identity.Configuration.Constants;
...
namespace Identity.Management.STS.Identity.Helpers
{
            ...
            if (cspTrustedDomains.Any())
            {
                app.UseCsp(csp =>
                {
                    csp.ImageSources(options =>
                    {
                        ...
                        options.CustomSources = new List<string>(cspTrustedDomains) {"data:"};
