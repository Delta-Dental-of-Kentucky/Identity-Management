...
using Identity.Management.STS.Identity.ViewModels.Consent;
using Identity.Management.STS.Identity.ViewModels.Device;

namespace Identity.Management.STS.Identity.Controllers
{
    [Authorize]
    [SecurityHeaders]
